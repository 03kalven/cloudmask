...
def get_model(w):
    ...
    conv1 = Conv2D(
        w, 3, activation="relu", padding="valid", kernel_initializer="he_normal"
    )(s)
    ...
    conv2 = Conv2D(
        2 * w, 3, activation="relu", padding="valid", kernel_initializer="he_normal"
    )(pool1)
    ...
    conv3 = Conv2D(
        4 * w, 3, activation="relu", padding="valid", kernel_initializer="he_normal"
    )(pool2)
    ...
    conv4 = Conv2D(
        8 * w, 3, activation="relu", padding="valid", kernel_initializer="he_normal"
    )(pool3)
    ...
    conv5 = Conv2D(
        16 * w, 3, activation="relu", padding="valid", kernel_initializer="he_normal"
    )(pool4)
    ...
    merge6 = concatenate(
        [
            experimental.preprocessing.CenterCrop(
                up6.get_shape()[1], up6.get_shape()[2]
            )(conv4),
            up6,
        ],
        axis=3,
    ...
    merge7 = concatenate(
        [
            experimental.preprocessing.CenterCrop(
                up7.get_shape()[1], up7.get_shape()[2]
            )(conv3),
            up7,
        ],
        axis=3,
    ...
    merge8 = concatenate(
        [
            experimental.preprocessing.CenterCrop(
                up8.get_shape()[1], up8.get_shape()[2]
            )(conv2),
            up8,
        ],
        axis=3,
    ...
    merge9 = concatenate(
        [
            experimental.preprocessing.CenterCrop(
                up9.get_shape()[1], up9.get_shape()[2]
            )(conv1),
            up9,
        ],
        axis=3,
...
def static_weighted_binary_crossentropy(true, pred, weight_zero=0.03693):
    """
    ...
    # apply the weights
    weights = true * (1.0 - weight_zero) + (1.0 - true) * weight_zero
